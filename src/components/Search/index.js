...
function Search() {
  return (
    <form className={styles.search}>
      <label className={`${styles.box} flex-v-center`}>
        <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <input className={`${styles.input} input-reset`} type='search' placeholder="search ..."></input>
      </label>
    </form>
  )
}
