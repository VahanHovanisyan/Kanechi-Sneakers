...
const Search = () => {
  return (
    <form className="search">
      <label className="searchBox flex-v-center">
        <svg className="searchIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <input className="searchInput input-reset" type='search' placeholder="search ..."></input>
      </label>
    </form>
  )
}
